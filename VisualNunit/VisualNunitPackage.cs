// VsPkg.cs : Implementation of VisualNunit
//
...
namespace BubbleCloudorg.VisualNunit
{
    ...
    public sealed class VisualNunitPackage : Package
    {
        /// <summary>
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            Microsoft.VisualStudio.ErrorHandler.ThrowOnFailure(uiShell.ShowMessageBox(
                       ...
                       ref clsid,
                       "VisualNunit",
                       string.Format(CultureInfo.CurrentCulture, "Menu item not yet implemented. Use NUnit View. Inside {0}.MenuItemCallback()", this.ToString()),
                       string.Empty,
                       0,
